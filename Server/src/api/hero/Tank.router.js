...
router.get("/topTankUnsold",  ValidateFilter.validateReqQuery,Tank.getTopTankListedLastedAndPaging)//* k can phan trang
router.get("/soldTankPaging", ValidateFilter.validateReqQuery, Tank.getTankSoldLastedAndPaging)
router.get("/tankUnsoldDetails/:id", Tank.getTankunSoldDetailsById)
router.get("/tankSoldDetails/:id", Tank.getTankSoldDetailsById)
router.get("/tankTopTank/filter", ValidateFilter.validateReqQuery, Tank.getTopListedLastedWithFilterAndPaging)//*remaing, price range , truyen qua request
router.get("/totalTankOwner/status", Authentication, ValidateFilter.validateReqQuery, Tank.getTotalTankOwnerWithStatusAndPaging)
