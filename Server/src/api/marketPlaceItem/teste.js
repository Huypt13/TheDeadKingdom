...
seller:"abc", buyer: null, price: 190}

const listBoxSelling = { marketItemId: "1231", nftContract: "012312", tokenId: "2",
seller: "abc", buyer: "qwe", price: 120}

const cancel = {marketItemId: "1231", nftContract: "012312", tokenId: "3",
seller: "abc", buyer: null, price: 120}

{(async()=>{
    // const rs = await TankUser.createTankUser(["6"],"abc","62f20d4b70d1f15ecd11c37a")
